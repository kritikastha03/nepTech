      ...
      <div className="flex items-center  w-[100%] overflow-hidden bg-[url('/banner_bg.webp')] h-screen bg-no-repeat bg-center bg-cover">
        <div className="ml-16 flex mt-6">
          <div className="w-[50%] flex  flex-col justify-cente mt-12">
            <h1 className=" mb-6 text-[38px] text-white font-semibold">
              AI Photo Enhancement, Generation & Editing Tools
            </h1>
            <p className="pb-8 w-[30rem] mt-1 text-lg font-medium text-white">
            ...
            <div className="flex gap-4 py-6 w-[90%]">
              <div className="btn w-[45%] flex items-center  justify-center  h-[62px] px-3 text-2xl font-semibold bg-yellow-600 text-black cursor-pointer rounded-md">
                Start Now
              </div>
              <div className="btn flex  p-4 gap-2 items-center  justify-center  h-[62px]  px-3 text-2xl font-mono font-bold bg-white text-black cursor-pointer rounded-[3px]">
                <IoLogoWindows />
                Free Download
              </div>
            </div>
